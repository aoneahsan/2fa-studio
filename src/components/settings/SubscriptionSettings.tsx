...
const SubscriptionSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-foreground mb-2">Subscription & Billing</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {plans.map((plan) => {
          ...
          const canUpgrade = plans.findIndex(p => p.id === plan.id) > plans.findIndex(p => p.id === user?.subscription.type);
          ...
          return (
            ...
            >
              ...
              <button
                ...
                disabled={isCurrentPlan || isProcessing || (plan.id !== 'free' && !canUpgrade)}
                className={`
      ...
      <div className="border-t border-border pt-6">
        <h3 className="text-sm font-medium text-foreground mb-4">Payment Methods</h3>
            ...
            <div key={i} className="flex items-center justify-between py-2">
              <div>
                <p className="text-sm font-medium text-foreground">
                  {currentPlan.name} Plan - {new Date(Date.now() - i * 30 * 24 * 60 * 60 * 1000).toLocaleDateString()}
                </p>
              ...
              <div className="text-right">
                <p className="text-sm font-medium text-foreground">${currentPlan.price}</p>
