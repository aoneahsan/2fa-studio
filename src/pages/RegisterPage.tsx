...
const RegisterPage: React.FC = () => {
	...
	const [confirmEncryptionPassword, setConfirmEncryptionPassword] =
		useState('');
	...
	const [encryptionStrength, setEncryptionStrength] =
		useState<PasswordStrength>({ score: 0, feedback: [] });
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			// Set encryption key
			const encryptionKey =
				await EncryptionService.hashPassword(encryptionPassword);
					...
					<div className='space-y-4'>
						...
						<div className='pt-4 border-t border-border'>
							...
							<p className='text-xs text-muted-foreground mb-3'>
								This password encrypts your 2FA codes. It's separate from your
								account password for extra security.
								<strong className='text-warning'>
									{' '}
									Remember it! We cannot recover this password.
								</strong>
							</p>
							...
							<div>
								<div className='relative'>
									...
									<input
										...
										onChange={(e) =>
											handleEncryptionPasswordChange(e.target.value)
										}
										className='input pl-10'
								...
								{encryptionPassword && (
									<div className='mt-2'>
										<p
											className={`text-xs ${getStrengthColor(encryptionStrength.score)}`}
										>
											Encryption strength:{' '}
											{getStrengthText(encryptionStrength.score)}
										</p>
									</div>
								)}
							</div>
						...
						<div>
							<label
								htmlFor='confirmEncryptionPassword'
								className='block text-sm font-medium text-foreground mb-2'
							>
								Confirm encryption password
							</label>
						...
						<div>
							...
							<p className='text-xs text-muted-foreground mt-1'>
								This hint will be shown when you need to enter your encryption
								password
							</p>
						</div>
					</div>
