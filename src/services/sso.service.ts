...
export class SSOService {
  ...
  static async initialize(): Promise<void> {
    try {
      ...
      console.error('Failed to initialize SSO service:', _error);
  ...
  static async createSSOConfig(
    ...
    try {
      ...
      console.error('Failed to create SSO _config:', _error);
      await ErrorMonitoringService.reportError(_error, {
        category: 'auth',
        severity: 'high',
  ...
  static async initiateSAMLLogin(
    ...
    try {
      ...
      console.error('Failed to initiate SAML login:', _error);
      await ErrorMonitoringService.reportError(_error, {
        category: 'auth',
        severity: 'high',
  ...
  static async handleSAMLResponse(
    ...
    try {
      ...
      console.error('Failed to handle SAML response:', _error);
      await ErrorMonitoringService.reportError(_error, {
        category: 'auth',
        severity: 'high',
  ...
  static async initiateOIDCLogin(
    ...
    try {
      ...
      console.error('Failed to initiate OIDC login:', _error);
      await ErrorMonitoringService.reportError(_error, {
        category: 'auth',
        severity: 'high',
  ...
  static async handleOIDCCallback(
    ...
    try {
      ...
      console.error('Failed to handle OIDC callback:', _error);
      await ErrorMonitoringService.reportError(_error, {
        category: 'auth',
        severity: 'high',
  ...
  static async testLDAPConnection(_config: LDAPConfig): Promise<boolean> {
    try {
      ...
      console.error('LDAP connection test failed:', _error);
      return false;
    }
  }
  ...
  static async getAvailableProviders(organizationId: string): Promise<SSOConfig[]> {
    try {
      ...
      console.error('Failed to get available SSO providers:', _error);
      return [];
    }
  }
  ...
  static async updateSSOConfig(
    ...
    try {
      ...
      console.error('Failed to update SSO _config:', _error);
      throw error;
    }
  }
  ...
  static async deleteSSOConfig(configId: string): Promise<void> {
    try {
      ...
      console.error('Failed to delete SSO _config:', _error);
      throw error;
    }
  }
  ...
  private static async createOrUpdateSSOUser(
    ...
    try {
      ...
      console.error('Failed to create or update SSO user:', _error);
      throw error;
    }
  }
