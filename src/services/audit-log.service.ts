...
export class AuditLogService {
  ...
  static async log(entry: AuditLogEntry): Promise<void> {
    try {
      ...
      try {
        ...
        console.error('Error getting IP address:', _error);
      }
  ...
  static async searchLogs(params: AuditLogSearchParams): Promise<{
    ...
    try {
      ...
      const q = query(collection(db, this.AUDIT_LOGS_COLLECTION), ...constraints);
      ...
      console.error('Error searching audit logs:', _error);
      throw error;
    }
  }
  ...
  static async getStats(
    ...
    try {
      ...
      snapshot.docs.forEach((doc) => {
        ...
        if (data.severity === 'critical' || data.action.includes('suspicious')) {
      ...
      console.error('Error getting audit log stats:', _error);
      throw error;
    }
  }
  ...
  static async detectSuspiciousActivity(userId: string): Promise<boolean> {
    try {
      ...
      console.error('Error detecting suspicious activity:', _error);
      return false;
    }
  }
  ...
  private static async triggerSecurityAlert(auditLog: unknown): Promise<void> {
    try {
      ...
      console.error('Error triggering security alert:', _error);
    }
  }
  ...
  static async cleanupOldLogs(): Promise<number> {
    try {
      ...
      console.error('Error cleaning up old logs:', _error);
      return 0;
    }
  }
  ...
  static async exportLogs(
    ...
    try {
      ...
      console.error('Error exporting audit logs:', _error);
      throw error;
    }
  }
