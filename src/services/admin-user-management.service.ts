...
export class AdminUserManagementService {
  ...
  static async banUser(
    ...
    try {
      ...
      console.error('Error banning user:', _error);
      throw error;
    }
  }
  ...
  static async getUserActionHistory(
    ...
    try {
      ...
      console.error('Error getting user action history:', _error);
      return [];
    }
  }
  ...
  private static async enhanceUserWithAdminData(user: User): Promise<AdminUser> {
    try {
      ...
      console.error('Error enhancing user with admin data:', _error);
      return {
        ...user,
        accountsCount: 0,
        backupsCount: 0,
  ...
  private static calculateRiskScore(user: User, violations: number, usage: unknown): number {
    let score = 0;
  ...
  private static async logUserAction(
    ...
    try {
      ...
      console.error('Error logging user action:', _error);
    }
  }
  ...
  private static async sendUserNotification(
    ...
    try {
      ...
      console.error('Error sending user notification:', _error);
    }
  }
  ...
  private static async cancelUserSubscriptions(userId: string, reason: string): Promise<void> {
    try {
      ...
      console.error('Error canceling user subscriptions:', _error);
    }
  }
}